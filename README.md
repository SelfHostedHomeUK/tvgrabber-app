...
> **Disclaimer:** This tool automates managing torrent downloads you provide — it does not search for, index, or provide access to any copyrighted material. It's intended for use with legally obtained content (content you own the rights to, public domain works, freely licensed material, etc.). You're responsible for ensuring your use complies with copyright law in your jurisdiction.
